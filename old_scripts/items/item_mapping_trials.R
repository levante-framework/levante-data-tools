# sync between airtable (pilot-item-mapping-trial table for coding missing item UIDs)
# and redivis (dataset item_metadata, table item_mapping_trial)
...
# connect to 
item_table <- airtable(table = "pilot-item-mapping-trial", base = "appIk9XNTZZns1F1F")
...
trial_table <- item_metadata$table("item_mapping_trial")
